...
normalizeEmail('TestMail@GMAIL.CoM');
...
checkFileExtension('myfile.PDF');
checkFileExtension('myfile.excel');
...
censorWord('JavaScript is fun and JavaScript is useful', 'JavaScript');
...
titleCase('javascript is very powerful');
